        ...
        <div className="mt-16 items-center justify-between gap-20 md:mt-28 md:flex">
          ...
          <div>
            ...
            <div className="relative">
              <div className="before:absolute before:-top-20 before:-left-20 before:z-[-1] before:content-(--content-abstractwaves)">
                <motion.div
                  initial="hidden"
                  whileInView="visible"
                  viewport={{ once: true, amount: 0.5 }}
            ...
            <div className="relative mt-16">
              <div className="before:absolute before:right-40 before:-bottom-20 before:z-[-1] before:content-(--content-sparkles)">
